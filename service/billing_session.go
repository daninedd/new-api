...
func (s *BillingSession) Refund(c *gin.Context) {
	...
	logger.LogInfo(c, fmt.Sprintf("User %d request failed, refunded pre-consumed quota (token_quota=%s, funding=%s)",
		s.relayInfo.UserId,
...
func (s *BillingSession) preConsume(c *gin.Context, quota int) *types.NewAPIError {
	...
	if s.shouldTrust(c) {
		effectiveQuota = 0
		logger.LogInfo(c, fmt.Sprintf("User %d has sufficient quota, trusted and no pre-consumption needed (funding=%s)", s.relayInfo.UserId, s.funding.Source()))
