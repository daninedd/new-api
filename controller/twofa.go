...
func Setup2FA(c *gin.Context) {
	...
	if existing != nil && existing.IsEnabled {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": "2FA is already enabled. Disable it before setting it up again.",
		})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "2FA setup initialized successfully. Scan the QR code with an authenticator app and enter the code to finish setup.",
