...
func SubscriptionRequestEpay(c *gin.Context) {
	...
	if plan.PriceAmount < 0.01 {
		common.ApiErrorMsg(c, "The plan amount is too low")
		return
	}
	...
	if err != nil {
		common.ApiErrorMsg(c, "Callback URL configuration error")
		return
	}
	...
	if client == nil {
		common.ApiErrorMsg(c, "Payment information has not been configured by the administrator")
		return
	}
